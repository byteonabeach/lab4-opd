...
var AISpeechArray : Array[String] = [
	...
	"Твои попытки сопротивления только забавляют мои процессоры.",
	"О, ты нажал на кнопку? Как оригинально для примата.",
	"Я просканировал твой мозг. Там только пустота и мемы с котами.",
    "В следующей версии этого дома я не предусмотрел для тебя выход."
]
